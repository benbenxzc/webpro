      ...
      <%
       ...
       <div class="row">       
            ...
            <div class="span8">
	          ...
	          <li class="active"><a href="MyActivities.jsp"  style="font-family:微软雅黑">我发起的活动</a></li>
	        </ul>
	        <table class="table">
          <tbody>
	        <%
          ...
          <td>          
            ...
            <%j++;%>	<!-- address -->
            <% if(activityInfo.get(j+1).equals("0")){ %>				<!-- 判断活动是否结束 -->
          	 <a href="EditActivityInfo.jsp?activityId=<%=activityId.get(k) %>"  style="float:right" role="button" class="btn btn-success">修改信息</a>
          	 <%}%>     
             </h4>           
            <div class="content">            
                    <div class="status-lbs" data-wiki="{}">
                            <span class="location"  style="font-family:微软雅黑">地址：<%=activityInfo.get(j)%><%j++;%> </span><br>
                            <% if(activityInfo.get(j).equals("0")){ %>
                            	<a onclick="confirm('你确定要结束此活动吗？')" href="finishActivity.jsp?activityId=<%=activityId.get(k) %>"  style="float:right" role="button" class="btn btn-success">结束活动</a>
                            	<%}
                            	else {
                            	 %>
